...
#### 練習項目 - 資料處裡 ####
# 處裡目標 : 
# 1. 由變數 para 中，抓取所有公告主旨，以 list 資料行儲存
# 2. 由變數 para 中，抓取所有網址連結
# 	(如 : href = 'http://www.ccxp.nthu.edu.tw/' 中的 'http://www.ccxp.nthu.edu.tw/')
#	同樣以 list 的方式儲存
# 3. 將對應的主旨與網址合成一個 dict
# 	注意 : 中英文標題的順序前後顛倒
# 4. 將 dict 依序輸出在一個 file (檔案名稱.txt)
